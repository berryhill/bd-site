...
- Verify issue #118 social preview images keep the shared terminal/operator OG template system for both site-level `/og.png` and post-level dynamic OG images; do not reintroduce old off-brand colors (`#1c1917`, `#ff8c42`, `#a0153e`) or generic logo-card layouts.

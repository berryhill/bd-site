...
New non-draft posts must also pass the issue #99 title-quality guardrail before publication/API write: the rendered title is the post title plus ` | berryhill.dev` and must stay at or below 65 characters. Avoid near-duplicate adjacent/recent public titles; draft posts skip this runtime gate until they are made non-draft.
